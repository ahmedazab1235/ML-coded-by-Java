...
public class AirBNBExample {
    public static void main(String[] args) {
       ...
       // airbnbDF.printSchema ();
        ...
        RandomForest.setFeaturesCol ("features");
        RandomForest.setLabelCol ("price");

        RandomForestRegressionModel linearRegressionModel=RandomForest.fit (airbnbDFTrainTransform);
