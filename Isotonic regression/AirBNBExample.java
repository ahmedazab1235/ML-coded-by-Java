...
public class AirBNBExample {
    public static void main(String[] args) {
       ...
       // airbnbDF.printSchema ();
        ...
        isotonicRegression.setFeaturesCol ("features");
        isotonicRegression.setLabelCol ("price");

        IsotonicRegressionModel isotonicRegressionModel=isotonicRegression.fit (airbnbDFTrainTransform);

        airbnbDFTest=vectorAssembler.transform (airbnbDFTest.na().drop ());
        final Dataset<Row> predictions = isotonicRegressionModel.transform(airbnbDFTest);
        predictions.show();
    }
}
